...
CREATE OR REPLACE STAGE SNOWRETAIL_DB.SNOWRETAIL_SCHEMA.PDF DIRECTORY = (ENABLE = TRUE);
...
-- Githubからファイルを持ってくる
COPY FILES INTO @SNOWRETAIL_DB.SNOWRETAIL_SCHEMA.FILE FROM @GIT_INTEGRATION_FOR_HANDSON/branches/takada-0822/data/ PATTERN ='.*\\.csv$';
COPY FILES INTO @SNOWRETAIL_DB.SNOWRETAIL_SCHEMA.PDF FROM @GIT_INTEGRATION_FOR_HANDSON/branches/takada-0822/data/ PATTERN = '.*\\.pdf$';
